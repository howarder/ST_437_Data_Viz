...
url1 <- "https://howarder.github.io/ST_437_Data_Viz/Assets/Datasets/countries.csv"
url2 <- "https://howarder.github.io/ST_437_Data_Viz/Assets/Datasets/countriesExtra.csv"
...
```{r}
innerJoinedData <- countriesDs |>
    inner_join(countriesExtraDs, by = "country")
```

```{r}
leftJoinedData <- countriesDs |>
    left_join(countriesExtraDs, by = "country")
```

```{r}
rightJoinedData <- countriesDs |>
    right_join(countriesExtraDs, by = "country")
```
