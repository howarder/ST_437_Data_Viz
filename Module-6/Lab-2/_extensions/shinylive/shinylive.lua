...
return {
  {
    CodeBlock = function(el)
      ...
      -- Check if quartoArgsParsed and components are defined
      local quartoArgsParsed = parsedCodeblock["quartoArgs"]
      if not quartoArgsParsed or not quartoArgsParsed.components then
        throw_quarto_error(
          "Missing or undefined 'components' in the parsed Quarto arguments.",
          "The 'components' key is missing or undefined in the parsed Quarto arguments. Please check your input code block."
        )
      end
